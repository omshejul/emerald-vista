    ...
    <main className="flex min-h-screen flex-col items-center ">
      ...
      <div className="grid container place-items-center">
        <Para className="text-justify border rounded-md p-12 border-white border-opacity-10">
          ...
          the Platform and the Services are proprietary to us and are licensed
          to us. You will not have any authority to claim any intellectual
          property rights, title, or interest in its contents. The contents
          include and is not limited to the design, layout, look and graphics.
          ...
          and/or applicable laws. You agree to pay us the charges associated
          with availing the Services. You agree not to use the Platform and/ or
          ...
          majeure event. These Terms and any dispute or claim relating to it, or
      ...
      <div className="grid container place-items-center">
        <Para className="text-justify border rounded-md p-12 border-white border-opacity-10">
          ...
          Platform such as name, date of birth, address, telephone/mobile
          number, email ID and/or any such information shared as proof of
          identity or address etc. all of the above being in accordance with
          ...
          reward programs and other payment opted by you. These disclosures may
          be required for us to provide you access to our services offered to
          you, to comply with our legal obligations, to enforce our user
          agreement, to facilitate our marketing and advertising activities, to
          ...
          safety of our users or the general public. <br />
          <br /> <span className="font-semibold">Security Precautions:</span> To
          protect your personal data from unauthorised access or disclosure,
          ...
          you disclose to us any personal data relating to other people, you
          represent that you have the authority to do so and permit us to use
          the information in accordance with this Privacy Policy. You, while
      ...
      <div className="grid container place-items-center">
        <Para className="text-justify border rounded-md p-12 border-white border-opacity-10 ">
          ...
          <b>
            ...
            refund requests will be solely at the discretion of the management.
          </b>
        </Para>
      </div>
      <Footer />
