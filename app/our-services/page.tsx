    ...
    <main className="flex min-h-screen flex-col items-center">
      ...
      <div className="mt-40 w-full max-w-5xl h-max">
        <iframe
          ...
          src="https://www.youtube.com/embed/kUgafETXzYc?si=-qQmbxwD0FJh2czk"
      ...
      <div>
        {/* Tab buttons */}
        <div
          className="tabContainer w-full flex justify-center text-center"
          id="servicesDiv"
        >
          {tabs.map((tab) => (
            <Tab
              ...
              selectedTab === tab.label && (
                ...
                >
                  <div className="container py-4 px-1 lg:px-4 flex flex-wrap">
                    ...
                    >
                      <div className="absolute  text-xl top-1/2 left-1/2 text-center transform -translate-x-1/2 -translate-y-1/2 ">
                        {tab.label}
                      </div>
                      <Image
...
const Tab: React.FC<TabProps> = ({ label, isActive, onClick }) => {
  return (
    <button
      className={`tab-button p-2 m-2 color text-black rounded-2xl bg-white ${
        isActive ? "active" : ""
      }`}
      onClick={onClick}
    >
